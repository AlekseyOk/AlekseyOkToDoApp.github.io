...
const ToDoItemComplete = withAuth(({ text, isCompleted, removeTask, completeTask, id, date, textTitle, priority, editTaskTitle, editTask, isAuthorized }) => (
 ...
 <div className="success"><Badge variant="success">Success</Badge></div>
